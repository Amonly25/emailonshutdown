...
public class SSLEmail {
	...
	public static void email(String Subject, String body) {
		...
		System.out.println("Smtp: SSLEmail Start");
		Logs.logToFile("Smtp: SSLEmail Start");
		
		Properties props = new Properties();
		
		props.put("mail.smtp.host", plugin.getConfig().getString("smtp_config.host")); 
		props.put("mail.smtp.socketFactory.port", plugin.getConfig().getString("smtp_config.port"));
